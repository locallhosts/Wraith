...
const platformAreas = [
  ...
  { title: "Validation", description: "Synthetic attack telemetry, benign baselines, detection checks and adversarial mutation evidence.", status: "Verified locally" },
  { title: "Integrations", description: "Elasticsearch and Neo4j are part of the local validation stack; additional SIEM backends are exposed by the translation layer.", status: "Implemented" },
...
const plannedAreas = [
  ...
  ["#planned-mutations", "Mutation lab", "Interactive mutation generation and per-variant evidence."],
  ["#planned-robustness", "Robustness workspace", "Historical robustness results and comparative detection coverage."],
